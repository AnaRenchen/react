  ...
  return (
    <div className="contendor_profile">
      <p className="texto_profile">
        ...
        characterized by having a great content of symbology, the result of his
        personal interest in the history of Asia, which ranges from mythology,
        Buddhism, Shinto, legends, novels, wars, Japanese folklore, among
        others. The pursuit of his work is to maintain the richness of the
